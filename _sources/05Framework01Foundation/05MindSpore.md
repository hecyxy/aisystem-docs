...
![MindSporeIntroduction.png](../images/05Framework01Foundation/05MindSpore01.png)
...
![MindSporeIntroduction.png](../images/05Framework01Foundation/05MindSpore02.png)
...
![02AutomaticDifferentiation.png](../images/05Framework01Foundation/05MindSpore03.png)
...
![ComputationalGraph](../images/05Framework01Foundation/05MindSpore04.png)
...
![01MindSporeIntroduction04](../images/05Framework01Foundation/05MindSpore05.png)

#### 自适应梯度求和

与传统的分布式训练中的梯度更新不同，自适应梯度求和考虑到梯度的方向。在网络训练初期，不同batch获得的梯度更新方向基本是平行的，但是随着训练进行，梯度更新方向趋向于正交。而且网络的不同层梯度更新的正交性差异也是比较大的。
 
![01MindSporeIntroduction05](../images/05Framework01Foundation/05MindSpore06.png)
...
![01MindSporeIntroduction06](../images/05Framework01Foundation/05MindSpore07.png)
