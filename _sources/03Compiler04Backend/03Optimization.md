...
-   带宽决定“房檐”的斜率（红色线段）
    ...
    ![img](../images/03Compiler04Backend/03optimization_01.jpg)
...
![img](../images/03Compiler04Backend/03optimization_02.webp)
...
![image-20240526203405335](../images/03Compiler04Backend/03optimization_03.png)

+   华为 TBE 张量加速引擎

    TBE（Tensor Boost Engine）负责执行昇腾 AI 处理器中运行在 AI Core 上的算子，TBE 提供了基于 TVM 框架的自定义算子开发能力，通过 TBE 提供的 API 可以完成相应神经网络算子的开发。

    ![image-20240526203607467](../images/03Compiler04Backend/03optimization_04.png)
...
![img](../images/03Compiler04Backend/03optimization_05.webp)
