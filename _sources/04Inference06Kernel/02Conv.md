...
![卷积可视化动图](../images/04Inference06Kernel/02.conv01.gif) 
...
![卷积取值的示例](../images/04Inference06Kernel/02.conv09.png) 
...
![t 不同取值情况下卷积的示例](../images/04Inference06Kernel/02.conv10.png) 
...
![系统随时间 t 的响应函数](../images/04Inference06Kernel/02.conv08.png) 
...
![对称变换后输出结果示意图](../images/04Inference06Kernel/02.conv14.png) 

进一步，将 $g(-t_{i})$ 图像右移 $T$ 个时间单位，得到 $g(T-t_{i})$:

![平移后输出结果示意图](../images/04Inference06Kernel/02.conv15.png) 
...
如下图所示, 神经网络中的卷积计算过程可描述为：$3 * 3$ 的卷积核在 $8 * 8$ 的图像上进行滑动，每次滑动时，都把卷积核和对应位置的元素进行相乘再求和。青色区域为其感受野。
 ...
 ![神经网络中卷积计算过程](../images/04Inference06Kernel/02.conv02.png) 
...
![卷积乘加过程](../images/04Inference06Kernel/02.conv16.png) 
...
![卷积滑动求和过程](../images/04Inference06Kernel/02.conv17.png) 
...
![卷积加偏置过程](../images/04Inference06Kernel/02.conv05.png) 
...
![张量](../images/04Inference06Kernel/02.conv07.png) 
...
![张量卷积计算示意图](../images/04Inference06Kernel/02.conv18.png) 
