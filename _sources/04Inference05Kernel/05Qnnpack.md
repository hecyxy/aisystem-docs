...
![矩阵乘法示意图](./../images/04Inference05Kernel/QNNPACK07.png)

一般经过向量化优化后，同时可以并行计算多个结果数据，则一次计算一块 MR × NR 的小块。

![向量化优化后计算 MR×NR](./../images/04Inference05Kernel/QNNPACK08.png)
...
![传统 im2col + GEMM 方法](./../images/04Inference05Kernel/QNNPACK01.png)
...
![间接卷积算法示意图](./../images/04Inference05Kernel/QNNPACK02.png)
...
![Repacking 示意图](./../images/04Inference05Kernel/QNNPACK09.png)
...
![有间接缓冲区与直接 GEMM 对比](./../images/04Inference05Kernel/QNNPACK03.png)
...
![间接卷积算法工作流程图](./../images/04Inference05Kernel/QNNPACK04.png)
...
![间接缓冲区布局](./../images/04Inference05Kernel/QNNPACK05.png)
...
![性能对比](./../images/04Inference05Kernel/QNNPACK06.png)
