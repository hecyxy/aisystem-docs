...
![三维张量示例](../../images/05Framework03DataFlow/023FW_DataFlow/graph_framework02.png)
...
![对应计算图](../../images/05Framework03DataFlow/023FW_DataFlow/forward_mode01.png)
:width:`550px`
...
![对应计算图](../../images/05Framework03DataFlow/023FW_DataFlow/compute_graph03.png)
:width:`400px`
...
![对应计算图](../../images/05Framework03DataFlow/023FW_DataFlow/compute_graph04.png)
:width:`400px`

对于上面表达式求值的过程称之为反向微分。在反向微分中，变量导数的计算顺序与变量的前向计算顺序正好相反；运行的时间复杂度是 $O(m)$，$m$ 是输出变量的个数。因此可以构建相对应的反向计算图：

![对应计算图](../../images/05Framework03DataFlow/023FW_DataFlow/compute_graph06.png)
:width:`550px`
...
![对应计算图](../../images/05Framework03DataFlow/023FW_DataFlow/compute_graph05.png)
:width:`550px`
...
![对应计算图](../../images/05Framework03DataFlow/023FW_DataFlow/framework04.png)
