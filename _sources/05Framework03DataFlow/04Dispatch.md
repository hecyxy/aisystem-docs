...
![计算图执行通用架构](../../images/05Framework03DataFlow/023FW_DataFlow/framework05.png)
...
![正向计算图](../../images/05Framework03DataFlow/023FW_DataFlow/forward_mode03.png)
:width:`550px`
...
![执行队列时间轴](../../images/05Framework03DataFlow/023FW_DataFlow/forward_mode02.png)
:width:`550px`
...
![算子多队列并发调度](../../images/05Framework03DataFlow/023FW_DataFlow/forward_mode04.png)
:width:`550px`
...
![算子异构调度](../../images/05Framework03DataFlow/023FW_DataFlow/forward_mode05.png)
:width:`550px`
...
![算子异构调度](../../images/05Framework03DataFlow/023FW_DataFlow/forward_mode06.png)
:width:`650px`
...
![图下沉硬件执行](../../images/05Framework03DataFlow/023FW_DataFlow/graph_framework01.png)
...
![针对 Transformer 模型并行](../../images/05Framework03DataFlow/023FW_DataFlow/model_parallel02.png)
:width:`550px`
...
![基本的 Inception 模块执行策略](../../images/05Framework03DataFlow/023FW_DataFlow/model_parallel01.png)
:width:`550px`
...
![PyTorch 算子执行](../../images/05Framework03DataFlow/023FW_DataFlow/dispatch03.png)
:width:`500px`
