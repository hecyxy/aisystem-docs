...
![内存中数据示意图](../images/03Compiler03Frontend/04LayoutPrinc01.png)
...
![无内存对齐机制示意图](../images/03Compiler03Frontend/04LayoutPrinc02.png)

总体上来说，如果有内存对齐，如下图所示，我们只需读取一次，而没有内存对齐机制，将导致访问请求数据所需的内存事务数增加至 2 倍。

![内存对齐机制示意图](../images/03Compiler03Frontend/04LayoutPrinc03.png)
...
![张量示意图](../images/03Compiler03Frontend/04LayoutPrinc04.png)
...
![3 维张量行优先示意图](../images/03Compiler03Frontend/04LayoutPrinc05.png)

下图为列优先排布方式，按列的顺序以红橙红橙红橙的排布方式，第二个通道绿蓝绿蓝绿蓝的排布方式进行存储。

![3 维张量列优先示意图](../images/03Compiler03Frontend/04LayoutPrinc06.png)
...
![3 维张量数据布局方式列举图](../images/03Compiler03Frontend/04LayoutPrinc07.png)
...
![NCHW 示意图](../images/03Compiler03Frontend/04LayoutPrinc08.png)
...
![NCHW 计算灰度值示意图](../images/03Compiler03Frontend/04LayoutPrinc09.png)
...
![NHWC 示意图](../images/03Compiler03Frontend/04LayoutPrinc10.png)
...
![NHWC 计算灰度值示意图](../images/03Compiler03Frontend/04LayoutPrinc11.png)
...
![连续张量示意图](../images/03Compiler03Frontend/04LayoutPrinc12.png)
...
![非连续张量示意图](../images/03Compiler03Frontend/04LayoutPrinc13.png)
