...
![Nvida GPU Tensor Core 发展](../images/02Hardware04NVIDIA/02HistoryTC01.png)
...
![](../images/02Hardware04NVIDIA/02HistoryTC02.png)

## 第一代 Tensor Core（Volta）

在开始介绍 Volta 架构中的第一代 Tensor Core 之前，我们先来了解一下 Volta 架构的实现细节。

![Volta SM](../images/02Hardware04NVIDIA/02HistoryTC03.png)
...
![Volta SM 微架构](../images/02Hardware04NVIDIA/02HistoryTC04.png)
...
![Volta Sub Core 微架构](../images/02Hardware04NVIDIA/02HistoryTC05.png)
...
![Turing Sub Core 微架构](../images/02Hardware04NVIDIA/02HistoryTC06.png)
...
![Ampere 多级带宽体系](../images/02Hardware04NVIDIA/02HistoryTC07.png)
...
![Ampere 异步内存拷贝机制](../images/02Hardware04NVIDIA/02HistoryTC08.png)
...
![Ampere FFMA](../images/02Hardware04NVIDIA/02HistoryTC09.png)
...
![Hopper FFMA](../images/02Hardware04NVIDIA/02HistoryTC10.png)
...
![Hopper TBC](../images/02Hardware04NVIDIA/02HistoryTC11.png)
...
![Hopper TBC Block](../images/02Hardware04NVIDIA/02HistoryTC12.png)
...
![Hopper 直接读取共享内存异步 Tensor Core](../images/02Hardware04NVIDIA/02HistoryTC13.png)
...
![Tensor Core 性能提升](../images/02Hardware04NVIDIA/02HistoryTC14.png)
