...
![人脸 landmark 的应用](../images/04Inference01Inference/example01.gif)
...
![利用华为 HMS Core 实现人脸检测](../images/04Inference01Inference/example02.gif?raw=true)

![利用华为 HMS Core 实现手势检测](../images/04Inference01Inference/example03.gif?raw=true)
