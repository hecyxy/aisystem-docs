...
![flashAttention](../images/04Inference05Optimize/03Extend03.png)
...
![flashAttention 算法方式](../images/04Inference05Optimize/03Extend04.png)
...
![flashAttention 算法方式](../images/04Inference05Optimize/03Extend05.png)
...
![flashAttention 算法方式](../images/04Inference05Optimize/03Extend06.png)

SRAM 上的输出 O 矩阵赋值为全 0，它将作为一个累加器保存 softmax 的累积分母，其中 l 也类似。m 用于记录每一行行最大分数，其初始化为-inf。

### 步骤三：切分子块

![flashAttention 算法方式](../images/04Inference05Optimize/03Extend07.png)

将 Q 划分成 Tr 个 Bolck，K、V 划分成 Tc 个 Block，初始化 attention output O，并划分成 Tr 个 Block。

### 步骤四：外循环加载 K、V 内循环加载 Q 子块

![flashattention cycle](../images/04Inference05Optimize/03Extend08.png)
...
![flashattention cycle](../images/04Inference05Optimize/03Extend09.png)
...
![flashattention cycle](../images/04Inference05Optimize/03Extend10.png)
...
![flashattention cycle](../images/04Inference05Optimize/03Extend11.png)
...
![softmax 计算方式 1](../images/04Inference05Optimize/03Extend12.png)
...
![softmax 计算方式 1](../images/04Inference05Optimize/03Extend13.png)
...
![softmax 计算方式 1](../images/04Inference05Optimize/03Extend14.png)
...
![数据节点转换](../images/04Inference05Optimize/03Extend15.png)
...
![内存优化](../images/04Inference05Optimize/03Extend16.png)
