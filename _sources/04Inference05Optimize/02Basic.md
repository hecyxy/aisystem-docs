...
![Constant folding](../images/04Inference05Optimize/02Basic01.png)
...
![ExpandDims](../images/04Inference05Optimize/02Basic02.png)
...
![Binary](../images/04Inference05Optimize/02Basic03.png)
...
![Op 本身无意义](../images/04Inference05Optimize/02Basic04.png)
...
![Op 无意义示例](../images/04Inference05Optimize/02Basic05.png)
...
![Op 参数无意义](../images/04Inference05Optimize/02Basic06.png)
...
![Op 参数无意义示例](../images/04Inference05Optimize/02Basic07.png)

### Op 位置无意义

一些 Op 在计算图中特殊位置会变得多余无意义。

![Op 位置无意义](../images/04Inference05Optimize/02Basic08.png)

详细示例如下所示：

示例中的 cast 算子，unsqueeze 算子以及无后续输出的 op1 和在 global pooling 之后的 reshape/flatten 算子等，均可以进行冗余算子的消除。

![Op 位置无意义](../images/04Inference05Optimize/02Basic09.png)
...
![Op 位置无意义](../images/04Inference05Optimize/02Basic10.png)
...
![Op 前后反义](../images/04Inference05Optimize/02Basic11.png)
...
![公共子图](../images/04Inference05Optimize/02Basic12.png)
...
![算子融合 conv](../images/04Inference05Optimize/02Basic13.png)
...
![算子融合 matmul](../images/04Inference05Optimize/02Basic14.png)
...
![算子替换 replace1vs1](../images/04Inference05Optimize/02Basic15.png)
...
![算子替换 replace1vsn](../images/04Inference05Optimize/02Basic16.png)
...
![算子前移](../images/04Inference05Optimize/02Basic17.png)
